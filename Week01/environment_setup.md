...
<!-- TOC -->autoauto- [Code Lab Week 1: Environment Setup](#code-lab-week-1-environment-setup)auto    - [MacOS](#macos)auto        - [Step 0-M: Install Homebrew and Xcode](#step-0-m-install-homebrew-and-xcode)auto        - [Step 1-M: Install Python and Pip](#step-1-m-install-python-and-pip)auto        - [Step 2-M:  Install Pipenv](#step-2-m--install-pipenv)auto        - [Step 3-M: Visual Studio Code](#step-3-m-visual-studio-code)auto        - [Step X-M: Switch from Bash to Zsh (strictly optional)](#step-x-m-switch-from-bash-to-zsh-strictly-optional)auto    - [Windows](#windows)auto        - [Step 0-W: Install WSL](#step-0-w-install-wsl)auto        - [Step 1-W: Install Python and Pip](#step-1-w-install-python-and-pip)auto        - [Step 2-W:  Install Pipenv](#step-2-w--install-pipenv)auto        - [Step 3-W: Visual Studio Code](#step-3-w-visual-studio-code)auto        - [Step X-W: Switch from Bash to Zsh (strictly optional)](#step-x-w-switch-from-bash-to-zsh-strictly-optional)autoauto<!-- /TOC -->
